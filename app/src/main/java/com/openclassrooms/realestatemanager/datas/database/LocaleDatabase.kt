...
@Database(entities = [Property::class, Agent::class, TypeOfProperty::class, Proximity::class, PropertyProximityCrossRef::class, ImageRoom::class, CrossRefInfosUpdate::class], version = 1, exportSchema = false)
